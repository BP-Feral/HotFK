...
def MenuLoop(game_engine):
    ...
    if game_engine.settings.get_width() == 1920 and game_engine.settings.get_height() == 1080:
        offline_banner = Button(game_engine.settings.get_width() // 4, game_engine.settings.get_height() // 5 * 2, "resources/images/buttons/offline_banner.png", "resources/images/buttons/offline_banner_hover.png", 1)
        online_banner = Button(game_engine.settings.get_width() // 4 * 3, game_engine.settings.get_height() // 5 * 2, "resources/images/buttons/online_banner.png", "resources/images/buttons/online_banner_hover.png", 1)
    else:
        offline_banner = Button(game_engine.settings.get_width() // 4, game_engine.settings.get_height() // 5 * 2, "resources/images/buttons/offline_banner.png", "resources/images/buttons/offline_banner_hover.png", 0.8)
        online_banner = Button(game_engine.settings.get_width() // 4 * 3, game_engine.settings.get_height() // 5 * 2, "resources/images/buttons/online_banner.png", "resources/images/buttons/online_banner_hover.png", 0.8)

    discord = Button(0 + 80, game_engine.settings.get_height() - 100, "resources/images/buttons/discord.png", "resources/images/buttons/discord_hover.png", 1)
    github = Button(0 + 200, game_engine.settings.get_height() - 100, "resources/images/buttons/github.png","resources/images/buttons/github_hover.png", 1)
    options = Button(game_engine.settings.get_width() - 200, game_engine.settings.get_height() - 100, "resources/images/buttons/options.png", "resources/images/buttons/options_hover.png", 1)
    leave = Button(game_engine.settings.get_width() - 80, game_engine.settings.get_height() - 100, "resources/images/buttons/quit.png","resources/images/buttons/quit_hover.png", 1)
    profile_card = Button(game_engine.settings.get_width() // 2, game_engine.settings.get_height() - 100, "resources/images/buttons/profile_card.png", "resources/images/buttons/profile_card.png", 1)
