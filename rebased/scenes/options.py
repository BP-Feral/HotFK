...
# Get Context
    ...
    music_volume_up = Button(game_engine.settings.get_width() / 2 + 364, 160, "resources/images/buttons/up.png", "resources/images/buttons/up_hover.png", 2, 0.5)
    music_volume_down = Button(game_engine.settings.get_width() / 2 + 314, 160, "resources/images/buttons/up.png", "resources/images/buttons/up_hover.png", 2, 0.5)
    music_volume_down.flip("horizontal")

    # Load Buttons (Sound Volume)
    sound_volume_up = Button(game_engine.settings.get_width() / 2 + 364, 210, "resources/images/buttons/up.png", "resources/images/buttons/up_hover.png", 2, 0.5)
    sound_volume_down = Button(game_engine.settings.get_width() / 2 + 314, 210, "resources/images/buttons/up.png", "resources/images/buttons/up_hover.png", 2, 0.5)
    sound_volume_down.flip("horizontal")

    # Load Buttons (Console Chat)
    console_toggle = Button(game_engine.settings.get_width() / 2 + 364, 360, "resources/images/buttons/box.png", "resources/images/buttons/box_hover.png", 2, 0.5)
    console_toggle_bool = game_engine.settings.get_console_toggle()

    # Load Buttons (Menu)
    button_reset = Button(game_engine.settings.get_width() // 2 - 200, game_engine.settings.get_height() - 80, "resources/images/buttons/reset.png", "resources/images/buttons/reset_hover.png", 2, 1)
    button_save = Button(game_engine.settings.get_width() // 2, game_engine.settings.get_height() - 80, "resources/images/buttons/save.png", "resources/images/buttons/save_hover.png", 2, 1)
    button_exit = Button(game_engine.settings.get_width() // 2 + 200, game_engine.settings.get_height() - 80, "resources/images/buttons/exit.png", "resources/images/buttons/exit_hover.png", 2 ,1)
