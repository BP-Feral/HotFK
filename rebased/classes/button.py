...
# Functions -------------------------------------------------- #
    def draw(self, screen):
        ...
        if self.rect.collidepoint(pos):
            ...
            self.rect.topleft = (self.rect.x, self.rect.y - self.hover_offset)
            pygame.draw.rect(screen, (255, 255, 255), (self.rect.x-2, self.rect.y-self.hover_offset-2, self.active.get_width()+4, self.active.get_height()+self.hover_offset+4), 2, 2)
